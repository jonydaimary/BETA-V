...
async def dc(ctx):
    ...
    embed=discord.Embed(title="Here's your GIF...", color=0Xf9fcfc)
    embed.set_image(url=random.choice(choices))
...
client2 = commands.Bot(description="marcos bot", command_prefix=commands.when_mentioned_or("*"), pm_help = True)
