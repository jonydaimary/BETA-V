...
async def status_task():
    while True:
        await client.change_presence(game=discord.Game(name='!!help | marcos.#0290')) 
...
async def joker(ctx):
    ...
    embed=discord.Embed(title="Hello Joker fan... Here's a GIF for you...", description="Tribute to the legendary **Heath Ledger**", color=0Xf9fcfc)
    embed.set_image(url=random.choice(choices))
...
async def botinfo(ctx):
    ...
    embed.add_field(name="__**invite bot**__", value="[click here](https://discordapp.com/api/oauth2/authorize?client_id=520267296506249216&permissions=8&scope=bot),)
